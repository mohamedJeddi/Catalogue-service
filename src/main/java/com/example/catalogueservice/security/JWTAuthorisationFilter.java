...
public class JWTAuthorisationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        response.addHeader("Access-Control-Allow-Headers","Origin,Accept,X-Requested-With,Content-Type,authorization,Access-Control-Request-Method," +
                "Access-Control-Request-Headers"); //quelles sont les entets que je t'authorize
